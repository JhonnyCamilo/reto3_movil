...
public class MainActivity3 extends AppCompatActivity implements OnMapReadyCallback {
                ...
                if (getApplicationContext() != null) {
                    ...
                    mMarker = mMap.addMarker(new MarkerOptions().position(
                            new LatLng(location.getLatitude(), location.getLongitude())
                                    ...
                                    .title("Tu posicion")
                                    .icon(BitmapDescriptorFactory.fromResource(R.drawable.icons8_marcador_96))
                    );
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(mOriginLatLng).title("Origen").icon(BitmapDescriptorFactory.fromResource(R.drawable.icons8_restaurant_96)));
        mMap.addMarker(new MarkerOptions().position(mOriginLatLng1).title("Origen").icon(BitmapDescriptorFactory.fromResource(R.drawable.icons8_restaurant_96)));
